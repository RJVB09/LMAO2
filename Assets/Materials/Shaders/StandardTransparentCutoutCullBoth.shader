Shader "LMAO2/StandardTransparentCutoutCullBoth" {
	Properties {
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			//float3 bgColor = tex2D(_GrabTexture,screenUV).rgb;
			...
			//o.Emission = lerp(bgColor,o.Emission,finalTex.a);

            // Metallic and smoothness come from slider variables
            o.Metallic = _Metallic * pbr.g;
            o.Smoothness = _Glossiness * pbr.r;
            o.Alpha = finalTex.a < 0.1 ? 0 : 1;
		}
