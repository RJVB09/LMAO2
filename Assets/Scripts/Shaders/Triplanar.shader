Shader "Standard Triplanar"
{
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutput o) 
        {
            ...
            half2 yUV = IN.worldPos.xz / _TextureScale + _TextureOffset;
            half2 xUV = IN.worldPos.zy / _TextureScale + _TextureOffset;
            half2 zUV = IN.worldPos.xy / _TextureScale + _TextureOffset;
